...
//    }
    ...
    public List<EmailResponseDTO> getEmailsForUser(String username, int is) {
        ...
        for (Email email : emails) {
            ...
            list.add(EmailResponseDTO.builder().id(email.getId()).title(email.getTitle()).content(email.getContent()).senderId(email.getSender().getUsername()).senderName(email.getSender().getUsername()).receiverIds(receivers).build());
    ...
    private EmailResponseDTO GetEmail(Email email) {
        ...
        return EmailResponseDTO.builder().id(email.getId()).title(email.getTitle()).content(email.getContent()).senderName(email.getSender().getName()).senderId(email.getSender().getUsername()).senderTime(sendTime).receiverIds(receiverList).build();
    }
    ...
    private EmailResponseDTO getEamil(Email email, List<String> filePathList) {
        ...
        return EmailResponseDTO.builder().id(email.getId()).senderName(email.getSender().getName()).title(email.getTitle()).content(email.getContent()).receiverIds(receiverList).senderId(email.getSender().getUsername()).senderTime(sendTime).filePathList(filePathList).build();
    }
